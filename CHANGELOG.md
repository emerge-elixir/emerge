...
- Declared headless Vulkan PRIME output with immutable `:sync_file` acquisition so its frames can open Vulkan consumer streams without weakening synchronization policy.
