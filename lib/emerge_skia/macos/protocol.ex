defmodule EmergeSkia.Macos.Protocol do
  ...
  defp encode_asset_config(asset_config) do
    ...
    svg_tree_max_entries = Map.fetch!(asset_config, :svg_tree_max_entries)
    svg_tree_max_bytes = Map.fetch!(asset_config, :svg_tree_max_bytes)
    ...
    <<encode_string_list(sources)::binary, runtime_enabled, encode_string_list(allowlist)::binary,
      ...
      cache_max_bytes::unsigned-big-64, svg_tree_max_entries::unsigned-big-64,
      svg_tree_max_bytes::unsigned-big-64, decode_at_size>>
  end
