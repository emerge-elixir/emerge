defmodule Emerge.CodeReloader.Watcher.FileSystem do
  @moduledoc false
  ...
  def start_link(opts) when is_list(opts) do
    if Code.ensure_loaded?(FileSystem) do
      ...
      {:error,
       {:missing_dependency,
        "Emerge.CodeReloader requires the :file_system dependency for watcher support. Add {:file_system, \"~> 1.0\", only: :dev} to the consuming application's deps."}}
    end
  end
