defmodule EmergeSkia do
  ...
  - `render_log` - Log native backend render/present diagnostics. High-volume event-runtime
    traces use Logger's `:debug` level. On Wayland, this also writes an out-of-band watchdog
